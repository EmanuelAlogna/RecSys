...
def evaluate_algorithm(URM_test , recommender_object ,playlist_unique):
    ...
    for user_id in playlist_unique:
        ...
        if len(relevant_items) > 0:
            ...
            recommended_item = recommender_object.recommend(at=5)
            num_eval += 1
...
def make_recommendations(recommender, target_playlists, URM_train):
    ...
    for playlist in target_playlists:
        recommendations = recommender.recommend(at=10)
