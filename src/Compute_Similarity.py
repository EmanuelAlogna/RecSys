...
from src.Compute_Similarity_Python import Compute_Similarity_Python
from src.Compute_Similarity_Euclidean import Compute_Similarity_Euclidean
        ...
        if similarity == "euclidean":
            ...
            if use_implementation == "cython":
                ...
                try:
                    ...
                    self.compute_similarity_object = Cosine_Similarity(dataMatrix, **args)
