...
from src.Evaluator import SequentialEvaluator
...
class MatrixFactorization_Cython(Recommender, Incremental_Training_Early_Stopping):
    ...
    def __init__(self, URM_train, positive_threshold=4, URM_validation = None, recompile_cython = False, algorithm = "MF_BPR",URM_test = None):
    ...
    def fit(self, epochs=100, batch_size = 1000, num_factors=10,
        ...
        from src.Cython.MatrixFactorization_Cython_Epoch import MatrixFactorization_Cython_Epoch
    ...
    def recommend2(self, user_id, at=None, exclude_seen=True, filter_top_pop=True):
        ...
        scores = np.dot(self.W[user_id],self.H.T)
