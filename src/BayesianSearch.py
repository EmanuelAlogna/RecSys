...
from src.AbstractClassSearch import AbstractClassSearch, DictionaryKeys
...
try:
    ...
    from src.BayesianOptimization_master.bayes_opt.bayesian_optimization import BayesianOptimization
