...
class DataReader(object):
    ...
    def __init__(self, file_path, split_train_test=False, train_test_ratio=0.8):
        self.URM_all = load_train("../../input/recommender-system-2018-challenge-polimi/" + file_path)
    ...
    def build_icm(self, file_path):
        ...
        ICM_all = load_track_attributes("../../input/recommender-system-2018-challenge-polimi/" + file_path)
        return ICM_all
